import { WORLD_MAP_CHUNK_HEIGHT, WORLD_MAP_CHUNK_SIZE_POWER } from "../../../vars";
import { hasBit, lowestMaxBit, powers } from "../../../../utils/game-utils";
...
export class ChunkHeightMap {
  ...
  /**
   * @param {THREE.Vector3|Object} objectSize
   * @param {Uint32Array} heightMap
   */
  constructor (objectSize, heightMap = null) {
